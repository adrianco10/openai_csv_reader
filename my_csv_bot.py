...
try:
    if not openai.api_key:
        st.warning("👈An OpenAI api key is needed to launch the bot")
    else:
        if csv_uploaded:
...
except openai.error.AuthenticationError as ie:
    st.warning("Incorrect API key provided: You can find your API key at "
